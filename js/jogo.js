$(document).ready(function() {
    ...
    const sounds = {  // captação do áudio mp3
      miando: $('#audio_gato_miando')[0],
      feliz: $('#audio_gato_ronronando')[0],
      bravo: $('#audio_gato_bravo')[0]
    };
    ...
    function showNextWord() {
      ...
      sounds.audio_gato_ronronando.play();  // toca o som do gato ronronando
      ...
      wordTimeout = setTimeout(() => {
        sounds.audio_gato_ronronando.pause();
    ...
    gameInput.on('input', function() {
      ...
      if(!targetWord.startsWith(typedText)) {
        ...
        setTimeout(() => {
          ...
          setCatState('feliz');  // o gato volta a ronronar
        }, 800);
        return;
      }
      ...
      if (typedText === targetWord) {
        ...
        sounds.audio_gato_ronronando.play();
        setCatState('feliz');
      ...
      // FUNÇÃO COM NOME DUPLICADO, VERIFICAR UTILIZAÇÃO E CORRIGIR NOME
      // function showNextWord() {
